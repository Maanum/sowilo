"""
Migration to update unique constraint on job_assessments table
"""
...
def upgrade():
    """Update unique constraint to be on opportunity_id only"""
    with engine.connect() as conn:
        ...
        conn.commit()
        print("Successfully updated unique constraint")
